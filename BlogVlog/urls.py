...
urlpatterns = [
    ...
    path('pasword-reset/done/' , auth_views.PasswordResetDoneView.as_view(template_name = 'users/password_reset-done.html'), name = 'password-reset-done'),
